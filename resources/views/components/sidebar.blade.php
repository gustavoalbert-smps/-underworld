				...
				<ul class="pb-2 space-y-2">
					...
					<li>
						...
						<ul id="dropdown-crud" class="space-y-2 py-2 hidden">
							<li>
								<a href="{{ "crud/products/"  }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Products</a>{{-- {{ if eq $page_slug "products" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
							</li>
							<li>
								<a href="{{ "crud/users/"  }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Users</a>{{-- {{ if eq $page_slug "users" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
							</li>
						</ul>
					</li>
					<li>
						<a href="{{ "settings/"  }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"> {{-- {{ if eq $page_slug "settings" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
					...
					<li>
						...
						<ul id="dropdown-playground" class="space-y-2 py-2"> {{-- {{ if not (eq .Params.group "playground") }}hidden {{ end }} --}}
							<li>
								<a href="{{ "playground/stacked/"  }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Stacked</a> {{-- {{ if eq $page_slug "stacked" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
							</li>
							<li>
								<a href="{{ "playground/sidebar/"  }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Sidebar</a> {{-- if eq $page_slug "sidebar" }} bg-gray-100 dark:bg-gray-700 {{ end }} --}}
							</li>
						</ul>
					</li>
				</ul>
